...
namespace LovelyMod.NPCs
{
	public class Cow : ModNPC
	{
		public override void SetStaticDefaults()
		{
			...
			Main.npcFrameCount[npc.type] = 16; //Because this NPC has 16 frames
		}
		...
		public override void FindFrame(int frameHeight)
		{
			...
			//TODO - Make cow eat grass periodically when it isn't moving
			//TODO - Add gore
		...
		public override void NPCLoot()
		{
			...
			Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("RawBeef"));
		}
	}
}
