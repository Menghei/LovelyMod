...
namespace LovelyMod.Items.Weapons
{
	public class Popper : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			item.shootSpeed = 0.01f; //Speed of projectile
			item.useAmmo = 270; //Arbitrary number for pebble ammo
		}
		...
		//Makes the gun held at the trigger rather than the stock
