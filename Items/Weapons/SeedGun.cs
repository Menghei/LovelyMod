...
//TODO - Let player pick up seeds when this is in their inventory
namespace LovelyMod.Items.Weapons
{
	public class SeedGun : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Shoots seeds.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shootSpeed = 16f;
			item.useAmmo = AmmoID.Dart; //Item ID for seed
		}
		...
		{
			//TODO - Make the player able to pick up seeds
		}
